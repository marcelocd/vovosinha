...
RSpec.describe Account do
  ...
  describe 'validations' do
    ...
    it { should validate_length_of(:company_name).is_at_least(Account::MIN_COMPANY_NAME_LENGTH) }
    it { should validate_length_of(:company_name).is_at_most(Account::MAX_COMPANY_NAME_LENGTH) }
  end
end
